...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for rolls in range(num_rolls):
        ...
        if point == 1:
            contains_1 = True
        total_points += point
    return 1 if contains_1 else total_points
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    op_score = (opponent_score//10)%10
    curr_score = player_score%10
    if 3*abs(op_score-curr_score) > 1:
        return 3*abs(op_score-curr_score)
    else:
        return 1
    # END PROBLEM 2
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    When its closer to winning, lower the threshhold
    """
    if score > opponent_score and score > 80:
        return sus_strategy(score, opponent_score, threshold=int(100-score)/2)
